...
// export const adminList = data => fetch('/modelsInfo', data)
export const adminList = () => fetch('/modelsInfo/')
...
export const addProject = data => fetch('/projectInfo/', data, 'POST')

/**
 * 添加模块
 */

export const addModel = data => fetch('/modelsInfo/', data, 'POST')
/**
 * 获取搜索地址
 */
...
export const addCase = data => fetch('/caseInfo/', data, 'POST')
