          ...
          <el-col :span="12" :offset="4">
            <el-form :model="formData" :rules="rules" ref="formData" label-width="110px" class="demo-formData">
              ...
              <el-form-item label="所属项目" prop="belong_project">
                <el-input v-model="formData.belong_project"></el-input>
              </el-form-item>
              <el-form-item label="所属模块" prop="belong_module">
                <el-input v-model="formData.belong_module"></el-input>
              </el-form-item>
              ...
              <el-form-item label="config/test" prop="include">
                <el-input v-model="formData.include"></el-input>
              </el-form-item>
              <el-form-item label="编写人员" prop="author">
                <el-input v-model="formData.author"></el-input>
              </el-form-item>
              <el-form-item label="请求信息" prop="request">
                <el-input v-model="formData.request" type="textarea"></el-input>
              </el-form-item>
...
import {cityGuess, addCase, searchplace, foodCategory} from '@/api/getData'
...
export default {
  data () {
    return {
      formData: {
        name: 'sdssdds', // 项目名称
        belong_project: 'belong_module', // 项目负责人
        belong_module: 'sssdasds', // 测试人员
        include: 'dsdasds', // 开发人员
        author: 'sdsdassds', // 相关应用
        request: 'sdsasddsd', // 简要描述
        status: '', // 状态
        type: 1
      },
      rules: {
    ...
    submitForm (formName) {
      ...
      this.$refs[formName].validate(async (valid) => {
        ...
        if (valid) {
          ...
          console.log('进入这里')
          try {
            let result = await addCase(this.formData)
            console.log(result)
            if (result.status === 1) {
              this.$message({
                type: 'success',
